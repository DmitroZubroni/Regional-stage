...
const ExecuteProposal = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try{
            ...
            await VotingService.executeProposal(proposalId, wallet)
            alert("голосование успешно выполненно")
        } catch {
            alert("не получилось выполнить голосование")
        }
    }

    return (
        <Form className="container" onSubmit={handleSubmit}>
            <h2> выполнить голосование </h2>
            <FormGroup>
            ...
            <Button variant="primary" type="submit" className='container'> выполнить </Button>
        </Form>
    )
}
